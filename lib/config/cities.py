...
class Cities:
    cities = [
        ...
        # {"id": "bremen", "name": "Bremen", "federal_state": "Bremen", "query": "Bremen, Germany", "area": 318, "inhabitants": 566_000,
        ...
        {"id": "duisburg", "name": "Duisburg", "federal_state": "Nordrhein-Westfalen", "query": "Duisburg, Germany",
         ...
         "transport_association": "vrr"},
        # {"id": "frankfurt-main", "name": "Frankfurt (Main)", "federal_state": "Hessen", "query": "Frankfurt (Main), Germany", "area": 248, "inhabitants": 764_000,
